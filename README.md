...
[![CI](https://github.com/OxideAV/oxideav-basic/actions/workflows/ci.yml/badge.svg)](https://github.com/OxideAV/oxideav-basic/actions/workflows/ci.yml) [![crates.io](https://img.shields.io/crates/v/oxideav-basic.svg)](https://crates.io/crates/oxideav-basic) [![docs.rs](https://docs.rs/oxideav-basic/badge.svg)](https://docs.rs/oxideav-basic) [![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
...
- **WAV** container: RIFF/WAVE (plus EBU Tech 3306 / ITU-R BS.2088
  ...
  **read+write symmetric** per Microsoft RIFF MCI §3 via the typed
  ...
  byte-lossless — the `smpl` loop array + vendor `sampler_data` tail
